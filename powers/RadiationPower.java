...
public class RadiationPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DefaultMod.makeID("RadiationPower");
    ...
    public void onAttack(DamageInfo info, int damageAmount, AbstractCreature target) {
        ...
        while(CHANCE >= 100){
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(target,info.owner, new IrradiatedPower(target,info.owner,1)));
            CHANCE -= 100;
        }
