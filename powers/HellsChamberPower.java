...
public class HellsChamberPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("HellsChamberPower");
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if (card.type == AbstractCard.CardType.ATTACK && !card.hasTag(BaseModCardTags.BASIC_STRIKE)) {
            this.flash();
    ...
    public AbstractPower makeCopy() {
        return new HellsChamberPower(owner, source, amount);
    }
}
