...
import Bromod.powers.AmmoRestorePower;
...
public class AmmoRestore extends AbstractPotion {


    public static final String POTION_ID = BroMod.makeID("AmmoRestore");
    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);

    public static final String NAME = potionStrings.NAME;
    public static final String[] DESCRIPTIONS = potionStrings.DESCRIPTIONS;
    private static final Texture containerImg = TextureLoader.getTexture(makePotionPath("AmmoRestore.png"));;
    ...
    public void use(AbstractCreature target) {
        ...
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(target, AbstractDungeon.player, new AmmoRestorePower(target,target, potency), potency));
