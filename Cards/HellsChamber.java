...
import Bromod.powers.HellsChamberPower;
...
public class HellsChamber extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(HellsChamber.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("HellsChamber.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new HellsChamberPower(p,p,0),0));
    }
