...
public class ThermiteRounds extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(ThermiteRounds.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("ThermiteRounds.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (upgraded){
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new HeatPower(p,p,magicNumber,false),magicNumber));
        }
    }
