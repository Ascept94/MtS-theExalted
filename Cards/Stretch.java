...
import Bromod.powers.StretchPower;
...
public class Stretch extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(Stretch.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("Stretch.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p,new StretchPower(p,p,0),0));
    }
