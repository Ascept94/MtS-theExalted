...
import Bromod.actions.SplitChamberAction;
...
public class SplitChamber extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(SplitChamber.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("SplitChamber.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
            AbstractDungeon.actionManager.addToBottom(new SplitChamberAction(p,p,magicNumber));
    }
