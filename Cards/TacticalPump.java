...
public class TacticalPump extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(TacticalPump.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("TacticalPump.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        int N = p.hand.group.size()-1;
        AbstractDungeon.actionManager.addToBottom(new DiscardAction(p,p,N,true));
