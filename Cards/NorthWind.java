...
public class NorthWind extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(NorthWind.class.getSimpleName());
    public static final String IMG = makeCardPath("NorthWind.png");
