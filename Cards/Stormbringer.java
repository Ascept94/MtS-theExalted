...
public class Stormbringer extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(Stormbringer.class.getSimpleName());
    public static final String IMG = makeCardPath("Stormbringer.png");
