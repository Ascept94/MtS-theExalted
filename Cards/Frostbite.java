...
public class Frostbite extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(Frostbite.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(m,p,new SlowPower(m,magicNumber),this.magicNumber));
        int dmg = this.damage + magicNumber;
        if (m.hasPower("Slow")){dmg += m.getPower("Slow").amount;}
