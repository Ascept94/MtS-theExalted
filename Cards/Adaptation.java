...
import Bromod.powers.AdaptationPower;
...
public class Adaptation extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(Adaptation.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("Adaptation.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new AdaptationPower(p,p,magicNumber), magicNumber));
    }
