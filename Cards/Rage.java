...
import Bromod.powers.RagePower;
...
public class Rage extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Rage.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("Rage.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new RagePower(p,p,magicNumber),magicNumber));
    }
