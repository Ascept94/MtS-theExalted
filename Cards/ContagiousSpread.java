...
public class ContagiousSpread extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(ContagiousSpread.class.getSimpleName());
    public static final String IMG = makeCardPath("ContagiousSpread.png");
