...
import Bromod.powers.ReflectionPower;
...
public class Reflection extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Reflection.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new ReflectionPower(p,p,magicNumber), magicNumber));
    }
