...
import Bromod.powers.IntensifyPower;
...
public class Intensify extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(Intensify.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("Intensify.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new IntensifyPower(p,p,1),1));
    }
