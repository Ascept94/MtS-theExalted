...
import Bromod.powers.BlastPower;
import Bromod.powers.ThunderboltPower;
...
public class Thunderbolt extends AbstractDynamicCard {
    ...
    public static final String ID = BroMod.makeID(Thunderbolt.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new BlastPower(p,p,magicNumber),magicNumber));
        if(!upgraded){
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new ThunderboltPower(p,p,0),0));
        }
    }
