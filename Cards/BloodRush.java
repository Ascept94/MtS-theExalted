...
import Bromod.powers.BloodRushPower;
...
public class BloodRush extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(BloodRush.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("BloodRush.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new BloodRushPower(p,p,0), 0));
    }
