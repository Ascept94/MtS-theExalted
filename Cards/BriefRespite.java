...
import Bromod.powers.BriefRespitePower;
...
public class BriefRespite extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(BriefRespite.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new BriefRespitePower(p,p,magicNumber), magicNumber));
    }
