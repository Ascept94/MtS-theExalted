...
import Bromod.powers.ProvokedPower;
...
public class Provoked extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(Provoked.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("Provoked.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p,new ProvokedPower(p,p,magicNumber), magicNumber));
    }
