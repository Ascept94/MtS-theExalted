...
public class TargetCracker extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(TargetCracker.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("TargetCracker.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (m.hasPower("Weakened")){
            ...
            if (upgraded){
                AbstractDungeon.actionManager.addToBottom(new DamageAction(m, dmgInfo, AbstractGameAction.AttackEffect.SLASH_DIAGONAL));
            }
        }
    }
