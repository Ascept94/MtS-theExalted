...
import Bromod.powers.EnergySiphonPower;
...
public class EnergySiphon extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(EnergySiphon.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("EnergySiphon.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p,new EnergySiphonPower(p,p,magicNumber),0));
    }
