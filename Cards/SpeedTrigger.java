...
public class SpeedTrigger extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(SpeedTrigger.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("SpeedTrigger.png");
