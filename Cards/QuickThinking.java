...
import Bromod.powers.QuickThinkingPower;
...
public class QuickThinking extends AbstractDynamicCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new QuickThinkingPower(p,p,magicNumber),magicNumber));
    }
