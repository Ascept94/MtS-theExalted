...
public class Continuity extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Continuity.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractPower po = p.powers.get(MathUtils.random(0,p.powers.size()-1));
