...
import Bromod.powers.LethalTorrentPower;
...
public class LethalTorrent extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(LethalTorrent.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("LethalTorrent.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p,new LethalTorrentPower(p,p,magicNumber,upgraded),magicNumber));
    }
